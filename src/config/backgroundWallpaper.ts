...
export const backgroundWallpaper: BackgroundWallpaperConfig = {
	...
	src: {
		...
		playerUrl: "/assets/videos/jinx.mp4",
	},
	// 横幅壁纸和全屏壁纸共享配置
	common: {
		...
		homeText: {
			...
			subtitle: [
				...
				"I thought you could love me like this... Even though I'm different.",
				"I'm glad it's you. Had to be you.",
				"She's back. The monster you created.",
				...
				"Here's a tip: don't get shot!",
				"Everybody Panic!",
				"Three, two, one, blow!",
				"Let's count to ten! Very fast!",
				"Whatever happens... I'm glad it was with you.",
			],
			// 主页横幅副标题字体大小
			subtitleSize: "2rem",
			typewriter: {
