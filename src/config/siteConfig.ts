...
export const siteConfig: SiteConfig = {
	...
	// 站点 URL
	site_url: "https://nullvert.uz",

	// 站点描述
	description:
		"Личный блог о технологиях, программировании, гаджетах, играх, полезных сервисах и софте. Обзоры, заметки, впечатления и мысли обо всём интересном.",
